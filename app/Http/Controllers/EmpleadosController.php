...
class EmpleadosController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //Modificacion para el archivo foto, se guarda en la carpeta storage/app/public/uploads
    ...
    public function destroy($id)
    {
        ...
        return redirect('empleados')->with('Mensaje','Empleado elemiminado  con exito');
    }
}
